          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Synchar supports partners across the full carbon removal lifecycle: building new
                projects, shaping strategy, and commercializing tonnes with proven playbooks.
              </p>
            </div>
